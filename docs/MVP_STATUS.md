...
| Atmosphere Panel widget skeleton (sky / visibility / rain_rate 등) | △ (widget ✓ + `AtmospherePropagator` (state_changed → `ScenarioComposer.set_atmosphere_hint` 매 edit 갱신) ✓; Editor Activity mount + ScenarioService 저장 미) |
...
**최종 갱신**: 2026-05-14 — Composer + Targets + Radar + AtmospherePropagator + MapEditor editor controllers ✓.
