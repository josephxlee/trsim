...
**최종 갱신**: 2026-05-13 — Phase 4 G3 (Map Editor Domain tab) 완료 후.
**누적 test**: 2413 PASS local, 5 contracts KEPT.
**HEAD**: G3 Map Editor 의 우측 panel 이 QTabWidget (Layers + Domain) 로.
